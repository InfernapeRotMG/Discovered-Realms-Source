...
public class PlayerMenu extends Menu {
    ...
    public function init(_arg_1:AGameSprite, _arg_2:Player):void {
        ...
        if (Player.isAdmin) {
            ...
            addOption(_local_3);
            _local_3 = new MenuOption(AssetLibrary.getImageFromSet("lofiInterfaceBig", 10), 0xFFFFFF, "Ban");
            _local_3.addEventListener(MouseEvent.CLICK, this.onBan);
            addOption(_local_3);
            _local_3 = new MenuOption(AssetLibrary.getImageFromSet("lofiInterfaceBig", 10), 0xFFFFFF, "IP Ban");
            _local_3.addEventListener(MouseEvent.CLICK, this.onIPBan);
            addOption(_local_3);
    ...
    private function onBan(_arg_1:Event):void {
        this.gs_.gsc_.playerText(("/ban " + this.player_.name_));
        remove();
    }

    private function onIPBan(_arg_1:Event):void {
        this.gs_.gsc_.playerText(("/ipban " + this.player_.name_));
        remove();
    }
