    ...
    partial class BehaviorDb
    {
        ...
        .Init("Mini Larva",
            new State(
                new State("idle",
                    ...
                    new Shoot(10, count: 4, projectileIndex: 0, fixedAngle: 10)
                    )
                )
            )
        ...
        .Init("Epic Larva",
            new State(
                ...
                new State("shoot1",
                    ...
                    new Shoot(10, count: 8, projectileIndex: 0, fixedAngle: 10, coolDownOffset: 1500),
                    new Shoot(10, count: 4, projectileIndex: 0, fixedAngle: 10, coolDownOffset: 2000)
                    ),
                new State("shoot4",
                    //toss Larva Puke
                    new Shoot(0, 3, shootAngle: 15, projectileIndex: 0, fixedAngle: 45, coolDownOffset: 1250),
        ...
        .Init("Woodland Silence Turret",
            new State(
                ...
                new State("idle",
                    new Shoot(10, count: 8, projectileIndex: 0, fixedAngle: 10)
                    )
                )
            )
