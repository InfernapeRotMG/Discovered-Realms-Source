        ...
        private static readonly Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>
            spawn = new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>
            {
                ...
                },
                {
                    ...
                    100, new []
                    {
                        Tuple.Create("Mysterious Crystal", 0.005),
                        Tuple.Create("Lucky Djinn", 0.005),
                        Tuple.Create("Lucky Ent God", 0.005),
                        ...
                        Tuple.Create("Djinn", 0.1),
                        Tuple.Create("Leviathan", 0.08),
                        Tuple.Create("Arena Headless Horseman", 0.005)
                    })
                },
            };
            ...
            foreach (var i in world.Players.Values)
                ...
                /* foreach (var i in manager.Clients.Values)
                     i.SendPacket(new TextPacket()
                     {
                         ...
                         Stars = -1,
                         Name = "@Announcement",
                         Text = "The realm has closed, portal will dissapear after 1 minute!"
                     }); */

                world.Timers.Add(new WorldTimer(60000, (no, ob) => //Is the "extra minute"
                {
        ...
        private static readonly Tuple<string, TauntData>[] criticalEnemies =
        {
            ...
            Tuple.Create("shtrs Defense System", new TauntData
            {
                 ...
                 killed = new[]
                {
                    ...
                    "How dare you kill The Avatar of the Forgotten King?!"
                }
            }),
