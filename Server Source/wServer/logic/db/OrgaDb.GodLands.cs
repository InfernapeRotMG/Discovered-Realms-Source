    ...
    partial class BehaviorDb
    {
        private _ GodLands = () => Behav()
            .Init("White Demon",
                ...
                new Threshold(0.18,
                    new ItemLoot("Potion of Attack", 0.08)
                    )
            ...
            .Init("Arena Headless Horseman",
                new State(
                    ...
                    //new DropPortalOnDeath("Haunted Cemetery Portal", 60)
                )
            )
            .Init("Sprite God",
                new State(
            ...
            .Init("Sprite Child",
                new State(
                    ...
                    new DropPortalOnDeath("Glowing Portal", 50)
                    )
            )
            .Init("Medusa",
                new State(
                    ...
                    new DropPortalOnDeath("Abyss of Demons Portal", 35)
                    ),
                new TierLoot(6, ItemType.Weapon, 0.04),
                new TierLoot(7, ItemType.Weapon, 0.02),
                new TierLoot(8, ItemType.Weapon, 0.01),
                ...
                new TierLoot(4, ItemType.Ability, 0.02),
                new Threshold(0.18,
                    new ItemLoot("Potion of Speed", 0.08)
                    )
            )
            .Init("Ent God",
                new State(
                ...
                new TierLoot(4, ItemType.Ability, 0.02),
                new Threshold(0.18,
                    new ItemLoot("Potion of Defense", 0.08)
                    )
            )
            .Init("Lucky Ent God",
                new State(
            ...
            .Init("Slime God",
                new State(
                    new DropPortalOnDeath("Toxic Sewers Portal", 20),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
