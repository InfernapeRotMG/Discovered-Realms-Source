...
public class ProductionSetup implements ApplicationSetup {
    ...
    private const SERVER:String = "185.44.78.82:8888"; //185.44.78.82:8888
    private const UNENCRYPTED:String = ("http://" + SERVER);
    private const ENCRYPTED:String = ("http://" + SERVER);
    private const BUILD_LABEL:String = "Discovered Realms #{VERSION}.{MINOR}";
    public static const BUILD_VERSIONNEW:String = "Pla";
    public static const BUILD_VERSIONOLD:String = "yer";
