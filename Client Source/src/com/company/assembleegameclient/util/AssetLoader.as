...
public class AssetLoader {
    ...
    private function addImages():void {
        ...
        AssetLibrary.addImageSet("d2LofiObjEmbed16", new EmbeddedAssets.d2LofiObjEmbed_().bitmapData, 16, 16);
        ...
        AssetLibrary.addImageSet("lofiObjCustom", new EmbeddedAssets.lofiObjCustomEmbed_().bitmapData, 8, 8);
        AssetLibrary.addImageSet("lofiObjCustom16", new EmbeddedAssets.lofiObjCustomEmbed_().bitmapData, 16, 16);
    ...
    private function addAnimatedCharacters():void {
        ...
        AnimatedChars.add("chars8x8rPets5", new EmbeddedAssets.chars8x8rPets5Embed_().bitmapData,null, 8, 8, 56, 8, AnimatedChar.RIGHT);
