    ...
    partial class BehaviorDb
    {
        ...
        .Init("Troll 3",
            ...
            new Threshold(0.05,
                ...
                new ItemLoot("Skeleton Warrior Skin", 0.02)
                )
            )
        .Init("Arena Mushroom",
            new State(
        ...
        .Init("Arena Ghost Bride",
            ...
            new Threshold(0.01,
                ...
                new ItemLoot("Wine Cellar Incantation", 0.01),
                new ItemLoot("Ghost Huntress Skin", 0.02)
                )
            )
        ...
        .Init("Ghost of Skuld",
            new State(
                ...
                new State("90",
                    new SetAltTexture(2),
                    new Shoot(10, 36, projectileIndex: 1, fixedAngle: 0, angleOffset: 90),
            ...
            new Threshold(0.01,
                ...
                new ItemLoot("Amulet of the Ressurected Warrior", 0.005)
                )
            )
