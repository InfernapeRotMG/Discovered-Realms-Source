...
namespace wServer.realm.entities.player
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
            ...
            : base(manager, (ushort)psr.Character.ObjectType, psr.Random)
        {
            try
            {
                ...
                if (Client.Account.Rank == 1)
                {
                    XpBoosted = true;
                    LootDropBoost = true;
                    LootDropBoostTimeLeft = 999999999;
                    LootTierBoost = true;
                    LootTierBoostTimeLeft = 999999999;
        ...
        private bool CheckLingo()
        {
            ...
            if (world == "Nexus" || world == "Vault" || world == "PetYard" || world == "SkinShop" || world == "Cloth Bazaar" || world == "GuildHall")//Just add => || world =="worldname" <= if you want to add another world
            {
                HP = Stats[0] + Stats[0];
                Mp = Stats[1] + Stats[1];
