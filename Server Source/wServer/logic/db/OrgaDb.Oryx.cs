...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Oryx = () => Behav()
            .Init("Oryx the Mad God 2",
                ...
                new Threshold(0.15,
                    ...
                    new ItemLoot("Blade of Drunken Rage", 0.01),
                    new ItemLoot("Bloody Chassis of Rage", 0.01),
					new ItemLoot("Wyrmhide Armor", 0.015),
                    ...
                    new ItemLoot("Dominion Armor", 0.015),
					new ItemLoot("Robe of the Star Mother", 0.015),
					new ItemLoot("Staff of the Vital Unity", 0.015),
					new ItemLoot("Dagger of Sinister Deeds", 0.015),
					new ItemLoot("Bow of Mystical Energy", 0.015),
					new ItemLoot("Wand of Evocation", 0.015),
					new ItemLoot("Sword of Splendor", 0.015)
                ),
                new Threshold(0.05,
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Frost Citadel Armor", 0.05),
                    new ItemLoot("Frost Elementalist Robe", 0.05),
                    new ItemLoot("Frost Drake Hide Armor", 0.05),
        ...
        #region Dance 2
                ...
                new Threshold(0.05,
                    new ItemLoot("Godly Seal Of The Blind", 0.03),
                    new ItemLoot("Godly Ring", 0.03),
                    new ItemLoot("Sword of the mad god", 0.01),
                    new ItemLoot("Onyx shield of the mad god", 0.01),
                    new ItemLoot("Almandine Armor of Anger", 0.01),
                    new ItemLoot("Almandine Ring of Wrath", 0.01),
        ...
        .Init("Oryx the Mad God 3",
                new State(
                    /*new State("Attack",
                        new Wander(.05),
                        new Shoot(25, projectileIndex: 0, count: 8, shootAngle: 45, coolDown: 1500, coolDownOffset: 1500),
                        new Shoot(25, projectileIndex: 0, count: 3, shootAngle: 60, coolDown: 1000, coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 0, count: 3, shootAngle: 75, predictive: 0.2, coolDown: 1000,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 0, count: 2, shootAngle: 90, predictive: 0.4, coolDown: 1000,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 0, count: 3, shootAngle: 105, predictive: 0.6, coolDown: 1000,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 0, count: 2, shootAngle: 120, predictive: 0.8, coolDown: 1000,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 0, count: 3, shootAngle: 135, predictive: 1, coolDown: 1000,
                            coolDownOffset: 1000),
                        new Taunt(1, 16000, "Puny mortals! I shall crush you, folks!"),
                        new Spawn("Henchman of Oryx", 6, coolDown: 5000),
                        new HpLessTransition(.4, "Launch")
                    ), */
                    new State("Attack",
                        new Wander(.05),
                        new Shoot(25, projectileIndex: 0, count: 8, shootAngle: 45, coolDown: 1200, coolDownOffset: 1500),
                        new Shoot(25, projectileIndex: 1, count: 3, shootAngle: 10, coolDown: 800, coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 2, count: 3, shootAngle: 10, predictive: 0.2, coolDown: 800,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 3, count: 2, shootAngle: 10, predictive: 0.4, coolDown: 800,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 4, count: 3, shootAngle: 10, predictive: 0.6, coolDown: 800,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 5, count: 2, shootAngle: 10, predictive: 0.8, coolDown: 800,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 6, count: 3, shootAngle: 10, predictive: 1, coolDown: 800,
                            coolDownOffset: 1000),
                        new Taunt(1, 6000, "Puny mortals! My {HP} HP will annihilate you!"),
                        new Spawn("Henchman of Oryx", 5, coolDown: 5000),
                        new HpLessTransition(.2, "Launch")
                    ),
                    new State("Launch",
                        new Follow(.1, 15, 5),
                        //new Taunt("Can't... keep... henchmen... alive... anymore! ARGHHH!!!"),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(25, 1, fixedAngle: 0, projectileIndex: 1, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 90, projectileIndex: 1, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 180, projectileIndex: 1, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 270, projectileIndex: 1, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 360, projectileIndex: 1, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 45, projectileIndex: 2, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 135, projectileIndex: 2, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 215, projectileIndex: 2, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 315, projectileIndex: 2, coolDown: 400, coolDownOffset: 100),
                        new Shoot(25, 1, fixedAngle: 45, projectileIndex: 2, coolDown: 400, coolDownOffset: 100),
                        new TimedTransition(10000, "slaughter")
                    ),
                    new State("slaughter",
                        new Follow(1, 15, 3),
                        new Shoot(25, projectileIndex: 0, count: 8, shootAngle: 45, coolDown: 1500, coolDownOffset: 1500),
                        new Shoot(25, projectileIndex: 1, count: 3, shootAngle: 10, coolDown: 1000, coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 2, count: 3, shootAngle: 10, predictive: 0.2, coolDown: 750,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 3, count: 2, shootAngle: 10, predictive: 0.4, coolDown: 750,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 4, count: 3, shootAngle: 10, predictive: 0.6, coolDown: 750,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 5, count: 2, shootAngle: 10, predictive: 0.8, coolDown: 750,
                            coolDownOffset: 1000),
                        new Shoot(25, projectileIndex: 6, count: 3, shootAngle: 10, predictive: 1, coolDown: 750,
                            coolDownOffset: 1000),
                        new Taunt(1, 6000, "Puny mortals! My {HP} HP will annihilate you!")
                    )
                ),
                ...
                new Threshold(0.25,
                    new ItemLoot("Potion of the Champion", 0.05)
                ),
                new Threshold(0.05,
                    new ItemLoot("Greater Potion of Attack", 0.5),
                    new ItemLoot("Greater Potion of Defense", 0.5),
                ...
                new Threshold(0.1,
                    new ItemLoot("Frost Citadel Armor", 0.06),
                    new ItemLoot("Frost Elementalist Robe", 0.07),
                    new ItemLoot("Frost Drake Hide Armor", 0.08),
                    new TierLoot(5, ItemType.Ring, 0.06)
                )
            )
