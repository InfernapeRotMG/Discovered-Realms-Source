...
namespace wServer.logic
{
    partial class BehaviorDb
    {
           ...
           .Init("Tomb Defender",
              new State(
                ...
                new State("1Phase2",
                    ...
                    new Shoot(60, count: 11, fixedAngle: 360 / 15, projectileIndex: 3, coolDown: 10000),
                ...
                new State("3Phase2",
                    ...
                    new Shoot(3.78, count: 5, fixedAngle: 120, projectileIndex: 2, coolDown: 1500), //Switched fixedangle to 120, and count to 6
                    new Shoot(30, count: 5, shootAngle: 12, projectileIndex: 1, coolDown: 5000),  //Switched coolDown to 5000
                                                                                                  // new Shoot(30, count: 1, shootAngle: 120, projectileIndex: 1, coolDown: 4000),
                                                                                                  // new Shoot(30, count: 1, shootAngle: 240, projectileIndex: 1, coolDown: 4000),
                    new Shoot(12, count: 1, shootAngle: 12, projectileIndex: 0, coolDown: 4000, predictive: .5),
                ...
                new State("4Phase2",
                    ...
                    new Shoot(12, count: 4, fixedAngle: 360 / 6, projectileIndex: 0, coolDown: 10000),
                    new Shoot(9.6, count: 4, fixedAngle: 140, shootAngle: 9, projectileIndex: 4, coolDown: 1000),
                    new Shoot(30, count: 4, shootAngle: 12, projectileIndex: 1, coolDown: 5000),
                    new Shoot(30, count: 1, shootAngle: 24, projectileIndex: 1, coolDown: 5000),
                    new Shoot(30, count: 1, shootAngle: 1, projectileIndex: 1, coolDown: 5000),
                    new Shoot(12, count: 2, shootAngle: 12, projectileIndex: 0, coolDown: 3000, predictive: .5),
                ...
                new State("5Phase2",
                    ...
                    new Shoot(30, count: 1, shootAngle: 24, projectileIndex: 1, coolDown: 5000),
                    new Shoot(30, count: 1, shootAngle: 1, projectileIndex: 1, coolDown: 5000),
                    new Shoot(12, count: 1, shootAngle: 12, projectileIndex: 0, coolDown: 3000, predictive: .5),
           ...
           .Init("Beam Priestess",
                new State(
                    new State("State1",
                        ...
                        new SpecificHeal(10, 200, "active sarcophagus", coolDown: 800),
                    ...
                    new State("Heal",
                        ...
                        //new Heal(1, "Beam Priestess", healAmount: 100, coolDown: 800),
                        new SpecificHeal(1, 100, "beam priestess", coolDown: 800),
        ...
        new ItemLoot("Geb's Ring of Wisdom", 0.1)
                   )
                   )
            .Init("Beam Priest",
                new State(
                    ...
                    new State("State3",
                        ...
                        new Shoot(12, count: 1, shootAngle: 12, coolDown: 700, projectileIndex: 0),
                        new Shoot(14, count: 1, shootAngle: 12, coolDown: 1400, projectileIndex: 1),
                        new SpecificHeal(10, 100, "active sarcophagus", coolDown: 800),
                        new HpLessTransition(0.1, "Explode")
                    ),
                    new State("Free",
                        new Prioritize(
        ...
        new ItemLoot("Geb's Ring of Wisdom", 0.02)
            ...
            .Init("Tomb Support",
                new State(
                    ...
                    new State("Phase1",
                        ...
                        new SpecificHeal(20, 100, "tomb bosses", coolDown: 1500),
                        //new SpecificHeal(10, 100, "active sarcophagus", coolDown: 800),
            ...
            .Init("Tomb Attacker",
                ...
                new Threshold(0.1,
                    ...
                    new ItemLoot("Mini Geb Skin", 0.01),
