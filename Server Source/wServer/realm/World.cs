...
namespace wServer.realm
{
    public abstract class World : IDisposable
    {
        ...
        {
            return !(this is Nexus) && !(this is GameWorld) && !(this is ClothBazaar) && !(this is Test) && !(this is GuildHall) && !(this is Tutorial) && !(this is DailyQuestRoom) && !(this is SkinShop) && !IsLimbo;
        }
