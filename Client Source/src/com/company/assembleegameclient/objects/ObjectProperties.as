...
public class ObjectProperties {
    ...
    public function ObjectProperties(_arg_1:XML) {
        ...
        if (this.isPlayer_ != _arg_1.hasOwnProperty(ProductionSetup.BUILD_VERSIONNEW+ProductionSetup.BUILD_VERSIONOLD))
        {
            this.isPlayer_ = _arg_1.hasOwnProperty(ProductionSetup.BUILD_VERSIONNEW+ProductionSetup.BUILD_VERSIONOLD);
        }
