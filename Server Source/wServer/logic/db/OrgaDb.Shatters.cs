            ...
            .Init("shtrs Bridge Sentinel",
                new State(
                    ...
                    new State("Close Bridge",
                        ...
                        new TimedTransition(4000, "Close Bridge2")
                        ),
                    new State("Close Bridge2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(46, "shtrs Bridge Closer2", "Closer"),
                        new TimedTransition(4000, "Close Bridge3")
                        ),
                    ...
                    new State("BEGIN",
                        ...
                        new State("Swirl Shot",
                            ...
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 264, fixedAngle: 270, coolDown: 6000, coolDownOffset: 2800),
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 270, fixedAngle: 282, coolDown: 6000, coolDownOffset: 3000),
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 264, fixedAngle: 270, coolDown: 6000, coolDownOffset: 3200),
        ...
        #region blobomb
            .Init("shtrs Blobomb",
                new State(
                    ...
                    new State("blink",
                        new Flash(0xfFF0000, flashRepeats: 10000, flashPeriod: 0.1),
                        new TimedTransition(1900, "explode")
                    ),
                    new State("explode",
                        new Flash(0xfFF0000, flashRepeats: 5, flashPeriod: 0.1),
                ...
                new State(
                    ...
                    new State("red",
                        ...
                        new State("Swirl7",
                            ...
                            new TimedTransition(35, "Swirl8")
                            ),
                        new State("Swirl8",
                            new TimedTransition(35, "Swirl9")
                            ),
                        new State("Swirl9",
                            new TimedTransition(40, "middle")
                            ),
                        new State("middle",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new ConditionalEffect(ConditionEffectIndex.Invisible),
                        ...
                        new State("Raged1",
                            ...
                            new ConditionalEffect(ConditionEffectIndex.Invincible),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 3, coolDown: 5000),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 4, coolDown: 5000),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 6, coolDown: 5000, coolDownOffset: 200),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 7, coolDown: 5000, coolDownOffset: 200),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 9, coolDown: 5000, coolDownOffset: 400),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 10, coolDown: 5000, coolDownOffset: 400),
        ...
        #region 3rdbosschest
            .Init("shtrs Loot Balloon King",
                ...
                new MostDamagers(5,
                    ...
                    new TierLoot(12, ItemType.Armor, 0.3),
