...
public class ButtonFactory {
    ...
    private static var itemButton:TitleMenuOption;
    ...
    public static function getItemButton():TitleMenuOption {
        return ((itemButton = ((itemButton) || (makeButton(ScreenTypes.ITEMS, BUTTON_SIZE_SMALL, RIGHT)))));
    }

    public static function getEditorButton():TitleMenuOption {
        return ((editorButton = ((editorButton) || (makeButton(ScreenTypes.EDITOR, BUTTON_SIZE_SMALL, LEFT)))));
    }
