    ...
    public partial class Player
    {
        private static readonly Dictionary<string, Tuple<int, int, int>> questDat =
            new Dictionary<string, Tuple<int, int, int>> //Priority, Min, Max
            {
                ...
                //Swoll Fairy,  Spoiled Creampuff, MegaRototo, Cupcake
                ...
                {"ds Gulpord the Slime God", Tuple.Create(20, 1, 1000)},

                {"shtrs Defense System", Tuple.Create(20, 20, 1000)},
                {"Dragon Head", Tuple.Create(20, 20, 1000)},
            };
