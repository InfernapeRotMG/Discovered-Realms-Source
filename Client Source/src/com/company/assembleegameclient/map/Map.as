...
public class Map extends AbstractMap {
    ...
    override public function setProps(_arg_1:int, _arg_2:int, _arg_3:String, _arg_4:int, _arg_5:Boolean, _arg_6:Boolean, _arg_7:String):void{
        width_ = _arg_1;
        height_ = _arg_2;
        name_ = _arg_3;
        back_ = _arg_4;
