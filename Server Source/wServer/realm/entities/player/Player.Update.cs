...
namespace wServer.realm.entities.player
{
    public partial class Player
    {
        ...
        public List<IntPoint> Tiles = new List<IntPoint>();

        public void SendUpdate(RealmTime time)
        {

            Tiles = (Owner is GameWorld || Owner is Nexus || Owner is Arena || Owner is PetYard ? Sight.GetSightCircle(SIGHTRADIUS).ToList() : Sight.Cast(this, SIGHTRADIUS).ToList());
