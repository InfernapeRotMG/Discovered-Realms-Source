            ...
            .Init(0x0d59, Behaves("Cube God",
                    ...
                    loot: new LootBehavior(LootDef.Empty,
                        Tuple.Create(100, new LootDef(0, 3, 0, 8,
                            ...
                            Tuple.Create(0.15, (ILoot)new StatPotionsLoot(1, 2)),
                            Tuple.Create(0.15, (ILoot)new TierLoot(4, ItemType.Ring)),

                            Tuple.Create(0.25, (ILoot)new TierLoot(4, ItemType.Ability)),
                            Tuple.Create(0.25, (ILoot)new TierLoot(8, ItemType.Armor)),

                            Tuple.Create(0.33, (ILoot)new TierLoot(8, ItemType.Weapon)),
                            Tuple.Create(0.33, (ILoot)new TierLoot(7, ItemType.Armor)),
                            Tuple.Create(0.33, (ILoot)new TierLoot(3, ItemType.Ring))
                        ))
                    )
                ))
