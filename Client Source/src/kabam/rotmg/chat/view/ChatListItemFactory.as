...
public class ChatListItemFactory {
    ...
    private function getNameColor():uint {
        if (this.message.name.charAt(0) == "=") { //specialrank
            return (0x000000);
        }
        if (this.message.name.charAt(0) == "!") { //4
            return (0xc302be);
        }
        if (this.message.name.charAt(0) == "#") { //3
            return (0xFFA800);
        }
        if (this.message.name.charAt(0) == "&") { //3
            return (0xFFFF00);
        }
        if (this.message.name.charAt(0) == "¤") { //2
            return (0xFF9900);
        }
        if (this.message.name.charAt(0) == "%") { //1
            return (0x00FFFF);
        }
