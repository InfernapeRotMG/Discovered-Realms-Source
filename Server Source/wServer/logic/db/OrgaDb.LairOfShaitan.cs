    ...
    partial class BehaviorDb
    {
        private _ LairofShaitan = () => Behav()
            .Init("md1 Head of Shaitan",
                new State(
                    new State("1",
                        ...
                        new State("3",
                            new Order(999, "md1 Right Hand of Shaitan", "2"),
                            new Order(999, "md1 Left Hand of Shaitan", "2"),
                    ...
                    new State("14",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(999, "md1 Right Hand spawner", "1"),
                        new Order(999, "md1 Left Hand spawner", "1"),
                    ...
                    new State("16",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(999, "md1 Right Hand of Shaitan", "TEST"),
                        new Order(999, "md1 Left Hand of Shaitan", "TEST"),
                    ...
                    new State("18",
                        ...
                        new State("19",
                            new Order(999, "md1 Governor", "1"),
                            new Order(999, "md1 Right Hand spawner", "2"),
                            new Order(999, "md1 Left Hand spawner", "2"),
                    ...
                    new State("22",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Order(999, "md1 Right Burst", "2"),
                        new Order(999, "md1 Mid Burst", "2"),
                        new Order(999, "md1 Left Burst", "2"),
            ...
            .Init("md1 Right Hand of Shaitan",
                new State(
                    ...
                    new State("3",
                        ...
                        new State("12",
                            new Order(999, "md1 Left Hand of Shaitan", "3"),
                        ...
                        new State("14",//unset conditional effect
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new Order(999, "md1 Head of Shaitan", "5"),
            ...
            .Init("md1 Left Hand of Shaitan",
                new State(
                    ...
                    new State("3",
                        ...
                        new State("12",
                            new Order(999, "md1 Right Hand of Shaitan", "14"),
                            new TimedTransition(0, "13")
                            )
                        ),
                        new State("TEST",
            ...
            .Init("md1 Loot Balloon Shaitan",
                ...
                new MostDamagers(4,
                    new ItemLoot("Greater Potion of Defense", 0.25)
                    ),
                new Threshold(0.01,
